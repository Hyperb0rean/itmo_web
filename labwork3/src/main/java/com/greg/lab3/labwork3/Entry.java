package com.greg.lab3.labwork3;
...
public class Entry implements Serializable {
    ...
    private boolean checkRectangle() {
        return xValue <= 0 && yValue <= 0 && Math.abs(xValue) <= rValue && Math.abs(yValue) <= (double)rValue;
    }
    ...
    public void checkHit() {
        hitResult = checkTriangle() || checkRectangle() || checkCircle() ? "idol.gif" : "rock.gif";
    }
